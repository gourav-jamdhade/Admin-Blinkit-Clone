...
class FilteringProducts(val adapterProduct: AdapterProduct, val filter: ArrayList<Product>) :
    Filter() {
    ...
    override fun publishResults(constraint: CharSequence?, result: FilterResults?) {
        ...
        adapterProduct.differ.submitList(result?.values as ArrayList<Product>)
    }
